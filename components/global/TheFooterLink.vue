  ...
  <div class="grid grid-cols-2 md:grid-cols-4 grid-flow-row gap-x-4 gap-y-8">
    ...
    <div class="space-y-7.5">
      <div class="col-lg-12 col-md-6">
        <h3 class="mb-2">GET OUR EXCLUSIVE NEWS IN YOUR INBOX <span class="text-accent-red">*</span></h3>
        <div class="">
            ...
            <div id="sib-form-container" class="sib-form-container">
              ...
              >
                <form
                  id="sib-form"
                  method="POST"
                  action="https://a5f651f1.sibforms.com/serve/MUIEAK8orXdmPYsPcPyMh1o6AZapz2jJWTVp2uZtUp38kr5gNy-B8EREL2fOU9tC7lx1fzy3lneVWPOY0bMqw3pUsBT92YBSJtSqxSXIpEW7yTc0wRZAhjnDCj5K6sMPM4DUPu4_0lm21DDKifncX8X-jXJvYa1ZhpbU7usbhjmx5cDjTjzTKBjroMJ2uY6YY25Lf78qGgFYHoHi"
                ...
                >
                    ...
                    <div class="form__entry entry_block">
                      <div class="form__label-row">
                        <div class="entry__field text-dark">
                          <input
                            class="input !text-neutral-normal"
                            type="text"
                            id="EMAIL"
                            name="EMAIL"
                            autocomplete="off"
                  ...
                  <div class="sib-form-block mt-2" style="text-align: left; margin-top: 16px !important">
                    <button
              ...
              <div
                id="error-message"
                class="sib-form-message-panel mt-2"
                style="
                  font-size: 14px;
                  text-align: left;
                  color: #661d1d;
