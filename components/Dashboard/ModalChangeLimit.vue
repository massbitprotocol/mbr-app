        ...
        <div class="flex flex-col">
          <div
            :class="{
              ...
              'border-primary': limitType === 'unlimit',
              'border-primary-background': !(limitType === 'unlimit'),
            }"
          >
            <label class="w-full inline-flex items-center">
              <input type="radio" name="limit" value="unlimit" v-model="limitType" />
              <span
                class="text-body-2 lg:text-body-1 text-neutral-darkest font-semibold ml-2"
                :style="{ color: !(limitType === 'unlimit') ? 'rgba(113, 117, 145, 0.6)' : null }"
              >
                Unlimited
              </span>
            </label>
          ...
          <div
            :class="{
              ...
              'border-primary': limitType === 'limit',
              'border-primary-background': !(limitType === 'limit'),
            }"
          >
            <label class="w-full inline-flex items-center">
              <input type="radio" name="limit" value="limit" v-model="limitType" />
              <span
                class="text-body-2 lg:text-body-1 text-neutral-darkest font-semibold ml-2"
                :style="{ color: !(limitType === 'limit') ? 'rgba(113, 117, 145, 0.6)' : null }"
              >
          ...
          <div class="w-full flex justify-end mt-10">
            <BaseButton class="w-[189px] h-[52px]" :loading="loading"> Save </BaseButton>
          </div>
        </div>
      </div>
    </div>
